...
let AuthController = class AuthController {
    ...
    googleAuth(dto) {
        return this.authService.loginWithGoogle(dto.googleId, dto.email, dto.name, dto.avatarUrl);
    }
    refreshToken(dto) {
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Logout and invalidate refresh tokens' }),

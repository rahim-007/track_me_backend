...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all habits with weekly logs' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a single habit' }),
    __param(0, (0, common_1.Request)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete (soft) a habit' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
...
__decorate([
    (0, common_1.Get)(':id/streak'),
    (0, swagger_1.ApiOperation)({ summary: 'Get habit streak' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], HabitsController.prototype, "getStreak", null);

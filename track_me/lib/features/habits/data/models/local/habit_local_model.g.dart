...
void _habitLocalModelAttach(
    IsarCollection<dynamic> col, Id id, HabitLocalModel object) {
  object.id = id;
}
...
extension HabitLocalModelByIndex on IsarCollection<HabitLocalModel> {
  ...
  List<Id> putAllByHabitIdSync(List<HabitLocalModel> objects,
      {bool saveLinks = true}) {
...
extension HabitLocalModelQuerySortBy
  ...
  QueryBuilder<HabitLocalModel, HabitLocalModel, QAfterSortBy> sortByEmoji() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitLocalModelQuerySortThenBy
  ...
  QueryBuilder<HabitLocalModel, HabitLocalModel, QAfterSortBy> thenByEmoji() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'emoji', Sort.asc);
    });
  }
...
extension HabitLocalModelQueryWhereDistinct
  ...
  QueryBuilder<HabitLocalModel, HabitLocalModel, QDistinct> distinctByCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLocalModel, HabitLocalModel, QDistinct> distinctByEmoji(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension HabitLocalModelQueryProperty
  ...
  QueryBuilder<HabitLocalModel, String, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLocalModel, String?, QQueryOperations> emojiProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HabitLocalModel, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
